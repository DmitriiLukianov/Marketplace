...
from .models import Orders, OrderItems, Delivery
...
def confirm_order(request):
    ...
    delivery = Delivery.objects.get(name='express') if request.GET.get('delivery') == 'express' else Delivery.objects.get(name='normal')
